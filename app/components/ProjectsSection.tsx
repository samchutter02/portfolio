...
const projects = [
  ...
  },
  {
    title: "Do Hue Recall?!",
    description:
      "A fun tool I designed to speed up CSS development and train your color code memorization skills. Choose either color to code or code to color mode and challenge yourself to recall hex codes or visualize colors from code. Or, simply mess with RGB and HEX sliders to see how colors interact with each other while also seeing the codes change!",
    image: "/code.jpg",
    tags: ["SwiftUI"],
                ...
                {project.liveUrl && (
                  <div className="mt-2 flex justify-end">
                    <a
                      ...
                      className="px-4 py-2 bg-blue-600 text-white rounded-full text-sm font-medium shadow hover:bg-blue-700 transition-colors dark:bg-blue-500 dark:hover:bg-blue-600"
                    >
                      View live →
                    </a>
                  </div>
